 ...
 * @author pchr
 */
public class FullNewtonRaphson extends Algorithm{
    private double tolerance;
    private int maxSteps;
    
    // constructor
    public FullNewtonRaphson(Analysis theAnalysis, double tolerance,int maxSteps){
    ...
    public FullNewtonRaphson(double tolerance,int maxSteps){
        this.tolerance=tolerance;
        this.maxSteps=maxSteps;
        this.theType=2;
    }
    ...
    public int solve(){
        ...
        while( (r.norm1()/theAnalysis.theSOE.getNormFext()>tolerance) && (iterations<maxSteps)  ){
            iterations++;
            theAnalysis.formLeft();
            //this.theAnalysis.getSOE().printK();
            theAnalysis.run();
            theAnalysis.update();
            ...
            if(iterations>=maxSteps&&r.norm1()/theAnalysis.theSOE.getNormFext()>tolerance){
                log=1;
            }
        }
        theAnalysis.commit();
