 ...
 * @author pchr
 */
public class ModifiedNewtonRaphson extends Algorithm{
    private double tolerance;
    private int maxSteps;
    
    // constructor
    public ModifiedNewtonRaphson(Analysis theAnalysis, double tolerance,int maxSteps){
    ...
    public ModifiedNewtonRaphson(double tolerance,int maxSteps){
        this.tolerance=tolerance;
        this.maxSteps=maxSteps;
        this.theType=3;
    }
